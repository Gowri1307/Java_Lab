...
class account
{
	...
	{
		System.out.println("\nRate of interest= 8%");
		ci=bal+bal*(Math.pow((1+(8/100)),2));
		System.out.println("Compound interest(for two years)= Rs"+ci);
	}*/
...
class savings extends account
{
	...
	public void withdrawal()
	{
		...
		System.out.print("\nEnter the amount to be withdrawm: ");
		amount=a.nextFloat();
		if(amount>super.bal)
		{
...
class current extends account
{
		...
		if(super.bal<1000)
    {
      ...
      System.out.println("\nService charge of Rs"+service_charge+" is deducted");
